...
class Project(models.Model):
    ...
    def project_to_jobcost_action(self):
        ...
        action['context'] = {'default_project_id':self.id,'default_analytic_id':self.account_id.id,'default_user_id':self.user_id.id}
        return action
...
class ProjectTask(models.Model):
    ...
    def task_to_jobcost_action(self):
        ...
        action['context'] = {'default_task_id':self.id,'default_project_id':self.project_id.id,'default_analytic_id':self.project_id.account_id.id,'default_user_id':self.env.user.id}
        return action
