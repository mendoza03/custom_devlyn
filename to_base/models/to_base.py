...
class TOBase(models.AbstractModel):
    ...
    def convert_local_to_utc(self, dt, force_local_tz_name=None, is_dst=None, naive=False):
        ...
        force_local_tz_name = force_local_tz_name or self.env.context.get('tz') or self.env.user.tz
    ...
    def calculate_weights(self, *item_weights, precision_digits=None, precision_rounding=None, rounding_method='HALF-UP'):
        ...
        :param precision_digits: number of fractional digits to round returned weights to.
        :type precision_digits: int
        :param precision_rounding: decimal number of returned weights representing the minimum
            non-zero value at the desired precision (for example, 0.01 for a
            2-digit precision).
        :type precision_rounding: float
