...
{
    'name': "Sales Job Cost Estimation: Materials, Labour, and Overhead",
    'version': '14.9.8',
    'price': 79.0,
    'depends': [
                'sale',
    ...
    'summary': """Sales Job Cost Estimation: Materials, Labour, and Overhead
                  Comprehensive Job Estimate Breakdown: Material, Labour & Overhead Costs
              """,
    'description': """
Odoo Sale Estimates
