...
class FingerTemplate(models.Model):
    ...
    device_user_id = fields.Many2one('attendance.device.user', string='Machine User', index=True,
    ...
    device_id = fields.Many2one('attendance.device', string='Attendance Machine',
                                related='device_user_id.device_id', store=True, precompute=True, index=True)
