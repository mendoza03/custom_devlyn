...
class TestFingerTemplate(Common):
    ...
    # Form test
    # Case 10: Tại list view Finger Template, thông tin Employee của mỗi bản ghi được tự cập nhật mỗi khi có sự thay đổi liên quan đến Device User của bản ghi đó
